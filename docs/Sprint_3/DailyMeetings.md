...
| Problem                 | Task                           | Owner       | Description                         |
|-------------------------|--------------------------------|-------------|-------------------------------------|
| Base de dades no pujades | Implementació User Stories 6.1 | Theo, Zihan | No es puja la base de dades sqlite3 |
| Error en music_engine_reserva.tecnic_id  | Implementació User Stories 6.2 | Ibra, Pau   | Problemes en la plantilla html      |

## Actions

| Type | Description                                  | Owner                  | Deadline   |
|------|----------------------------------------------|------------------------|------------|
| T    | Arreglar el git_ignore, eliminat el "sqlite" | Zihan, Theo, Ibra, Pau | 18-05-2023 |
| T    | Arreglat el models                           | Zihan, Theo, Ibra, Pau | 18-05-2023 |
T: Task
D: Decision
I: Information
